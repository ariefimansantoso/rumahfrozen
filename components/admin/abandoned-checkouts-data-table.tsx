...
export function AbandonedCheckoutsDataTable({
  ...
  const list = useListQuery<AbandonedCheckout>({
    endpoint: "/api/admin/abandoned-checkouts",
    initialPage,
    initialSearch,
    ...
    initialSortBy,
    initialSortOrder,
    initialFilters: { emailStatus: initialEmailStatus },
    errorMessage: "Failed to load abandoned checkouts",
  });
