...
export function BlogPostForm({ postId }: Props) {
  ...
  const ensureTitleForAI = () => {
    ...
    toast.error("Add a post title before using AI generation");
    return false;
  };
    ...
    <Form {...form}>
      ...
      >
        <AdminFormStickyHeader
          ...
          title={watchedTitle || (postId ? "Edit post" : "Add blog post")}
          status={
            <Badge
        ...
        <div className="grid grid-cols-1 gap-4 lg:grid-cols-3">
          <div className="space-y-4 lg:col-span-2">
            <Card className="gap-2">
              <CardHeader>
                <CardTitle>Title and content</CardTitle>
              </CardHeader>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input placeholder="A compelling headline" {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormDescription>
                        Auto-generated from the title. Edit to set a custom
                        handle.
                      </FormDescription>
                      <FormMessage />
                    </FormItem>
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <div className="flex items-center justify-between gap-2">
                        ...
                        <AiGenerateMenu
                          label="Generate"
                          placeholder="Summarise this post in a sentence or two…"
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <div className="flex items-center justify-between gap-2">
                        ...
                        <AiGenerateMenu
                          label="Generate"
                          placeholder="Write the post — topic, angle, what to cover…"
                          format="html"
                        ...
                        <RichTextEditor
                          ...
                          imageStudioSlot={(insertImage) => (
                            <AiStudioImageField
                              ...
                              breadcrumbRoot={
                                postId ? "Edit post" : "Add blog post"
                              }
                              breadcrumbLeaf="Content image"
                              savedMessage="Image added to content"
                              subjectNoun="image"
                            ...
                            >
                              {(open) => (
                                <Button
                                  ...
                                  title="Add image with AI Studio"
                                >
                        ...
                        <MediaUploader
                          ...
                          aiGenerateAction={
                            <AiStudioImageField
                              ...
                              breadcrumbLeaf="Featured image"
                              savedMessage="Saved to featured image"
                              subjectNoun="photo"
            ...
            <SearchEngineListingPreview
              ...
              entityLabel="post"
              emptyTitle="Post title"
              emptyDescription="Add a meta description to improve search results."
            ...
            <Card className="gap-2">
              ...
              <CardContent className="space-y-4">
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormDescription>Leave blank to use now</FormDescription>
                        <FormMessage />
                      </FormItem>
                    )}
                  />
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="flex items-center justify-between rounded-md border p-3">
                      <FormLabel className="m-0">Featured post</FormLabel>
                      <FormControl>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="flex items-center justify-between rounded-md border p-3">
                      <FormLabel className="m-0">Allow comments</FormLabel>
                      <FormControl>
                        <Switch checked={field.value} onCheckedChange={field.onChange} />
                      </FormControl>
                    </FormItem>
