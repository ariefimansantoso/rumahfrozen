    ...
    <>
      ...
      <div className="space-y-1.5">
        ...
        <Input
          ...
          placeholder={t("admin.settings.storage.placeholder.r2AccountId")}
      ...
      <div className="space-y-1.5">
        ...
        <Input
          ...
          placeholder={t("admin.settings.storage.placeholder.r2AccessKeyId")}
      ...
      <div className="space-y-1.5">
        ...
        <Input
          ...
          placeholder={t("admin.settings.storage.placeholder.r2SecretKey")}
          className="bg-background"
        />
