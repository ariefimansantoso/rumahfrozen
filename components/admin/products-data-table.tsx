...
export function ProductsDataTable({
  ...
  const list = useListQuery<Product>({
    ...
    initialPage,
    initialSearch,
    initialTab: normalizeStatus(initialStatus),
    initialSortBy: "createdAt",
    initialSortOrder: "desc",
    initialFilters: { vendor: initialVendor, source: initialSource, tag: "all" },
    errorMessage: t("admin.productsDataTable.toasts.fetchError"),
  });

  const vendorOptions = useMemo(
    () =>
      ((list.rawData as { filters?: { vendors?: { label: string; value: string }[] } } | undefined)
        ?.filters?.vendors) || [],
    [list.rawData],
  );
