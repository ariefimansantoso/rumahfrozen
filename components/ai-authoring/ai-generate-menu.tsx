  ...
  return (
    <Popover open={open} onOpenChange={setOpen} modal={false}>
      ...
      <PopoverContent
        ...
        className="pointer-events-auto w-[min(92vw,400px)] border-0 bg-transparent p-0 shadow-none"
      >
        <div
              ...
              {showTonePicker ? (
                <div className="flex items-center gap-2">
                  ...
                  >
                    <SelectTrigger
                      size="sm"
                      className="h-7 w-auto gap-1 border-0 bg-muted/50 px-2 text-xs"
                    >
                      <SelectValue />
                    </SelectTrigger>
            ...
            <div className="flex items-center justify-between gap-2 border-t px-3 py-2">
              {allowAttachment ? (
                <button
                  ...
                  title="Attach image"
                  className="grid h-8 w-8 place-items-center rounded-full text-foreground/70 transition hover:bg-muted disabled:opacity-50"
                >
                  {uploading ? (
              ...
              <button
                ...
                disabled={loading}
                className="inline-flex items-center gap-1.5 rounded-full px-3 py-1.5 text-sm font-semibold text-foreground transition hover:bg-muted disabled:opacity-50"
              >
                {loading ? (
                  <Loader2 className="h-4 w-4 animate-spin" />
                ) : (
              ...
              <button
                ...
                aria-label="Generate"
                title="Generate"
                className="grid h-8 w-8 place-items-center rounded-full bg-foreground text-background transition hover:opacity-90 disabled:opacity-50"
              >
                {loading ? (
                  <Loader2 className="h-4 w-4 animate-spin" />
                ) : (
