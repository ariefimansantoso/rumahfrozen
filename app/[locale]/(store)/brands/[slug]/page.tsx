...
function buildPageUrl(page: number, sort?: string) {
    ...
    <Select defaultValue={currentSort || "featured"}>
      ...
      <SelectContent>
        <SelectItem value="featured">
          <a href={base}>{labels.featured}</a>
        </SelectItem>
        <SelectItem value="best-selling">
          <a href={`${base}?sort=best-selling`}>{labels.bestSelling}</a>
        </SelectItem>
        <SelectItem value="title-asc">
          <a href={`${base}?sort=title-asc`}>{labels.aToZ}</a>
        </SelectItem>
        <SelectItem value="title-desc">
          <a href={`${base}?sort=title-desc`}>{labels.zToA}</a>
        </SelectItem>
        <SelectItem value="price-asc">
          <a href={`${base}?sort=price-asc`}>{labels.priceLowHigh}</a>
        </SelectItem>
        <SelectItem value="price-desc">
          <a href={`${base}?sort=price-desc`}>{labels.priceHighLow}</a>
        </SelectItem>
        <SelectItem value="created-desc">
          <a href={`${base}?sort=created-desc`}>{labels.newest}</a>
        </SelectItem>
      </SelectContent>
    </Select>
  );
